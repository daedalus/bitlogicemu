...
# WIP
#
def alu_4bit(A,B,aInv,bInv,Op0,Op1):
	...
	Cout[0],Y[0],OF[0],SET[0] = alu_1bit(A[0],B[0],aInv,bInv,less,bInv,Op0,Op1)
	Cout[1],Y[1],OF[1],SET[1] = alu_1bit(A[1],B[1],aInv,bInv,less,Cout[0],Op0,Op1)
	Cout[2],Y[2],OF[2],SET[2] = alu_1bit(A[2],B[2],aInv,bInv,less,Cout[1],Op0,Op1)
	Cout[3],Y[3],OF[3],SET[3] = alu_1bit(A[3],B[3],aInv,bInv,less,Cout[2],Op0,Op1)
